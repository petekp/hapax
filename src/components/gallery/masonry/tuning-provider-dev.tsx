...
export function TuningProviderDev({ children }: { children: ReactNode }) {
  const values = useControls({
    ...
    "Entrance Animation": folder({
      ...
      rippleEnabled: { value: tuningDefaults.rippleEnabled, label: "Ripple Enabled" },
      rippleBaseDelay: { value: tuningDefaults.rippleBaseDelay, min: 0, max: 0.5, step: 0.02, label: "Ripple Base Delay (s)" },
      rippleDelayRange: { value: tuningDefaults.rippleDelayRange, min: 0, max: 2, step: 0.05, label: "Ripple Delay Range (s)" },
      rippleScaleFrom: { value: tuningDefaults.rippleScaleFrom, min: 0.8, max: 1, step: 0.01, label: "Ripple Scale From" },
      rippleSpringStiffness: { value: tuningDefaults.rippleSpringStiffness, min: 20, max: 300, step: 5, label: "Ripple Stiffness" },
      rippleSpringDamping: { value: tuningDefaults.rippleSpringDamping, min: 5, max: 30, step: 1, label: "Ripple Damping" },
    }),
...
`
  ...
  const tuningValues = useMemo((): TuningValues => ({
    ...
    rippleEnabled: values.rippleEnabled,
    rippleBaseDelay: values.rippleBaseDelay,
    rippleDelayRange: values.rippleDelayRange,
    rippleScaleFrom: values.rippleScaleFrom,
    rippleSpringStiffness: values.rippleSpringStiffness,
    rippleSpringDamping: values.rippleSpringDamping,
    ...
    values.rippleEnabled, values.rippleBaseDelay, values.rippleDelayRange,
    values.rippleScaleFrom, values.rippleSpringStiffness, values.rippleSpringDamping,
