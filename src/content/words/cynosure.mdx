...
1. A person or thing that draws all attention; the center toward which eyes and talk naturally turn (literary). Unlike a *celebrity*, a **cynosure** need not be famous—only magnetic.
